...
{
	HTHANDLE();
	HTHANDLE(int Capacity, int SecSnapshotInterval, int MaxKeyLength, int MaxPayloadLength, const wchar_t HTUsersGroups[512], const wchar_t FileName[512]);
	...
	wchar_t HTUsersGroup[512]; // группа OS пользователей
	HANDLE Mutex;
