...
---------------------------------------------------
CREATE DATABASE LINK MEOW
CONNECT TO C##PAV IDENTIFIED BY "qwe"
USING '192.168.134.55/orcl';


drop database link MEOW;
---------------------------------------
---------------------------------------
---------------------------------------
...
begin
    ...
    insert into RIS@MEOW(id,str) values(2,'tanya');
commit;
end;
...
begin
    ...
    update RIS@MEOW set str='tanya123' where str ='tanya';
commit;
end;

begin
    update RIS set str='nastya321' where str ='nastya';
    insert into RIS@MEOW(id,str) values(6,'kasper');
commit;
end;
...
begin
    insert into RIS@MEOW(id,str) values(21,'rexd');
commit;
end;
