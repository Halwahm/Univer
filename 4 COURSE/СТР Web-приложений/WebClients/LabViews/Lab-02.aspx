...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Table runat="server" BorderStyle="None" Width="500px">
        <asp:TableRow>
            ...
            <asp:TableCell Width="40%">
                <asp:UpdatePanel runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:TextBox runat="server" ID="GetResult" ReadOnly="true" ToolTip="Result"></asp:TextBox>
                    </ContentTemplate>
                    <Triggers>
        ...
        <asp:TableRow>
            <asp:TableCell Width="20%">
                <asp:Button runat="server" ID="POSTBtn" Text="POST" OnClick="POSTBtn_Click" ValidationGroup="validators" />
            </asp:TableCell>
            <asp:TableCell Width="40%">
                <asp:TextBox runat="server" ID="Result" ToolTip="Parameter 'Result'"></asp:TextBox>
            </asp:TableCell>
            <asp:TableCell>
                ...
                <asp:UpdatePanel runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:Label runat="server" ForeColor="Red" ID="customerr1"></asp:Label>
                    </ContentTemplate>
                    <Triggers>
        ...
        <asp:TableRow>
            <asp:TableCell>
                <asp:Button runat="server" ID="PUTBtn" Text="PUT" OnClick="PUTBtn_Click" ValidationGroup="validators" />
            </asp:TableCell>
            <asp:TableCell>
                <asp:TextBox runat="server" ID="Add" ToolTip="Parameter 'Add'"></asp:TextBox>
            </asp:TableCell>
            <asp:TableCell>
                <asp:RegularExpressionValidator runat="server"
                ...
                <asp:UpdatePanel runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:Label runat="server" ForeColor="Red" ID="customerr2"></asp:Label>
                    </ContentTemplate>
                    <Triggers>
