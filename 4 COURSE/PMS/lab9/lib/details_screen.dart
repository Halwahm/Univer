    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: Icon(
              productProvider.isFavorite(widget.title)
                  ? Icons.favorite
                  : Icons.favorite_border,
              color: productProvider.isFavorite(widget.title)
                  ? Colors.red
                  : Colors.black,
              size: 40,
            ),
            onPressed: () {
              productProvider.toggleFavorite(widget.title);
            },
          ),
              ...
              Row(
                ...
                children: ['5', '5.5', '6', '6.5', '7'].map((size) {
                  return GestureDetector(
                    onTap: () {
                      productProvider.selectSize(size);
                    },
                    child: Container(
                      height: 50,
                      width: 50,
                      ...
                      decoration: BoxDecoration(
                        border: Border.all(
                          color: size == productProvider.selectedSize
