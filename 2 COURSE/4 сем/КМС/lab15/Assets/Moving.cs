...
{
    public AudioSource tankMovementSound; // звук движения танка
    ...
    void Update()
    {
        ...
        // Если танк движется, проигрываем звук движения танка
        if (x != 0 || z != 0)
        {
            if (!tankMovementSound.isPlaying)
            {
                tankMovementSound.Play();
            }
        }
        else
        {
