...
lib.ssMetadata = [
		{name:"жуки_HTML5 Canvas_atlas_1", frames: [[0,0,107,186]]}
];
...
(lib._return = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f().s("#B65123").ss(1,1,1).p("AjlA8IM9AAIAAiBIs9AAIAABFIAAA8IAADmIlykrIFykYIAACgIAAA8AjlAAIAKAAAjbiBIgKAA");
	this.shape.setTransform(60,29);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#FFFF33").s().p("ApXgJIFykYIAACgIAAA8IM9AAIAACBIs9AAIAAg8IAKAAIgKAAIAAhFIAABFIAAA8IAADmgAjlAAg");
	this.shape_1.setTransform(60,29);
...
p.nominalBounds = new cjs.Rectangle(-1,-1,122,60);
...
if (reversed == null) { reversed = false; }
	...
	// Слой_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FF0000").s().p("AkfEgIAAo/II/AAIAAI/g");
...
if (reversed == null) { reversed = false; }
	...
	// Слой_1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#B65123").ss(1,1,1).p("AElAAIpJFSIAAqjg");
	this.shape.setTransform(29.25,33.775);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#00FF00").s().p("AkklRIJJFRIpJFSg");
	this.shape_1.setTransform(29.25,33.775);
...
p.nominalBounds = new cjs.Rectangle(-1,-1,60.5,69.6);
...
if (reversed == null) { reversed = false; }
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#B65123").ss(1,1,1).p("AkfkeII/AAIAAI+Io/AAg");
	this.shape.setTransform(292.85,36.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.stopb},{t:this.startb},{t:this.returnb}]}).wait(60));
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/жуки_HTML5 Canvas_atlas_1.png?1677926805660", id:"жуки_HTML5 Canvas_atlas_1"},
		{src:"sounds/simplyclever.mp3?1677926805696", id:"simplyclever"},
		{src:"sounds/Sound_05773.mp3?1677926805696", id:"Sound_05773"},
		{src:"sounds/zhuzhzhaniezhuka.mp3?1677926805696", id:"zhuzhzhaniezhuka"}
	],
	preloads: []
};
