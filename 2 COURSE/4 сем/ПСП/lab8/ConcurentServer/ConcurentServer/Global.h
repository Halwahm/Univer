...
char* dllname = (char*)"ServiceLibrary"; //название загружаемой библиотеки 
char* npname = (char*)"smc"; //имя именованного канала, используемое ConsolePipe
char* ucall = (char*)"ABC"; //позывной сервера, используемый ResponseServer
...
struct Contact         // элемент списка подключений       
{
	...
	Contact( TE t = EMPTY, char* namesrv = (char*)"") // конструктор 
	{
