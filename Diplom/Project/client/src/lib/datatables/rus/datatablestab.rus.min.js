 ...
 * https://datatables.net/download/#bs-3.3.6/dt-1.10.11,r-2.0.2
 *
 * Included libraries:
 * Bootstrap 3.3.6, DataTables 1.10.11, Responsive 2.0.2
 */
...
"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": активировать сортировку по возрастанию столбцов",sSortDescending:": активировать для сортировки по убыванию столбца"},oPaginate:{sFirst:"Первые",sLast:"Последние",sNext:"Вперёд",sPrevious:"Назад"},sEmptyTable:"Нет данных в таблице",sInfo:"Показано с _START_ по _END_ из _TOTAL_ записей",sInfoEmpty:"Показано с 0 по 0 из 0 записей",
sInfoFiltered:"(отфильтровано из _MAX_ записей)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Показать _MENU_ записей",sLoadingRecords:"Загрузка...",sProcessing:"Обработка...",sSearch:"Поиск:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Нет подходящих записей"},oSearch:h.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
...
this._iDisplayLength,b=this._iDisplayStart,c=b+a,d=this.aiDisplay.length,e=this.oFeatures,f=e.bPaginate;return e.bServerSide?!1===f||-1===a?b+d:Math.min(b+a,this._iRecordsDisplay):!f||c>d||-1===a?d:c},oInstance:null,sInstance:null,iTabIndex:0,nScrollHead:null,nScrollFoot:null,aLastSort:[],oPlugins:{},rowIdFn:null,rowId:null};m.ext=v={buttons:{},classes:{},build:"bs-3.3.6/dt-1.10.11,r-2.0.2",errMode:"alert",feature:[],search:[],selector:{cell:[],column:[],row:[]},internal:{},legacy:{ajax:null},pager:{},renderer:{pageButton:{},
